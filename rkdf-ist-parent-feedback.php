...
$pageTitle = "Parent Feedback Form | RKDF IST | SRKU Bhopal";
$pageDesc = "Download official Parent Feedback Form for RKDF Institute of Science & Technology (RKDF IST), Sarvepalli Radhakrishnan University Bhopal.";
$pageKeywords = "Parent Feedback Form RKDF IST, Parents Review PDF SRKU, Engineering Parent Feedback Bhopal";
...
<div class="py-5 text-center text-white position-relative" style="background: linear-gradient(135deg, var(--srku-navy), var(--srku-maroon));">
    <div class="container-xl py-3">
        <span class="badge bg-warning text-dark fw-bold px-3 py-1 mb-2">Stakeholder Engagement</span>
    ...
    <div class="container-xl py-2">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-white p-3 rounded-4 shadow-sm border mb-0 small">
                ...
                <li class="breadcrumb-item active text-danger fw-bold" aria-current="page">Parent Feedback Form</li>
            </ol>
        </nav>
            ...
            <div class="row align-items-center g-4 position-relative z-2">
                <div class="col-12 col-lg-8">
                    <span class="badge bg-warning text-dark px-3 py-2 rounded-pill fw-bold mb-3">
                        <i class="fas fa-file-pdf me-1"></i> Prescribed Institutional Review Format
                    </span>
                    <h2 class="h2 fw-bold text-white mb-3">Parent Feedback Form &mdash; RKDF IST</h2>
                    <p class="text-white-50 mb-4" style="line-height: 1.7; font-size: 0.98rem;">
                        Official feedback and evaluation document for parents and guardians of RKDF Institute of Science &amp; Technology students. Parents can preview the complete form below and download the official PDF copy.
                    </p>
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo $pdfUrl; ?>" download="Parent-Feedback-Form-RKDF-IST.pdf" class="btn btn-warning text-dark fw-bold px-4 py-3 rounded-pill shadow">
                    ...
                    <div class="p-4 rounded-4 bg-white text-navy shadow-sm">
                        ...
                        <ul class="list-unstyled d-flex flex-column gap-2 mb-0 small">
                            ...
                            <li class="d-flex justify-content-between">
                                ...
                                <strong class="text-navy">Parents &amp; Guardians</strong>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card p-4 p-md-5 border-0 shadow-sm rounded-4 bg-white mb-4" id="pdf-viewer">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                        <div>
                            ...
                            <h3 class="h4 fw-bold text-navy mb-0">Parent Feedback Form Preview</h3>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="<?php echo $pdfUrl; ?>" download="Parent-Feedback-Form-RKDF-IST.pdf" class="btn btn-sm btn-danger rounded-pill px-3 fw-bold">
                    ...
                    <div class="border rounded-4 overflow-hidden shadow-sm bg-light" style="min-height: 650px; height: 800px;">
                        <iframe src="<?php echo $pdfUrl; ?>#toolbar=1" class="w-100 h-100" style="border:none;" title="Parent Feedback Form PDF">
