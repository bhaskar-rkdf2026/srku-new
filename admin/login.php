...
<body class="d-flex align-items-center justify-content-center min-vh-100 p-3" style="background: linear-gradient(135deg, #18183d 0%, #2a2a68 50%, #7a0b0d 100%);">
    ...
    <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5 w-100 bg-white" style="max-width: 440px; box-shadow: 0 20px 45px rgba(0,0,0,0.25) !important;">
        ...
        <form action="login.php" method="POST">
            ...
            <button type="submit" class="btn btn-danger w-100 py-2 fw-bold shadow-sm" style="background: linear-gradient(135deg, #7a0b0d, #d62529);">
