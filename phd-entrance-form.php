...
<section class="py-5 bg-light">
    <div class="container-xl py-2">
        ...
        <?php
        $phdEntrancePdf = getSetting('phd_entrance_pdf', BASE_URL . 'assets/uploads/pdf/phd-entrance-form.pdf');
            ...
            <div class="row align-items-center g-4 position-relative z-2">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo htmlspecialchars($phdEntrancePdf); ?>" download class="btn btn-warning text-dark fw-bold px-4 py-3 rounded-pill shadow">
                            <i class="fas fa-download me-2"></i> Download Official PDF Form
                        </a>
                        <a href="<?php echo htmlspecialchars($phdEntrancePdf); ?>" target="_blank" class="btn btn-outline-light fw-bold px-4 py-3 rounded-pill">
                ...
                <div class="card p-4 p-md-5 border-0 shadow-sm rounded-4 bg-white mb-4" id="pdf-viewer">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo htmlspecialchars($phdEntrancePdf); ?>" download class="btn btn-sm btn-danger rounded-pill px-3 fw-bold">
                                 <i class="fas fa-download me-1"></i> Download PDF
                            </a>
                            <a href="<?php echo htmlspecialchars($phdEntrancePdf); ?>" target="_blank" class="btn btn-sm btn-outline-navy rounded-pill px-3 fw-bold">
                    ...
                    <div class="ratio ratio-4x3 border rounded-4 overflow-hidden shadow-sm bg-light" style="min-height: 550px;">
                        <iframe src="<?php echo htmlspecialchars($phdEntrancePdf); ?>#toolbar=1" class="w-100 h-100" style="border:none;" title="Ph.D. Entrance Exam Form PDF">
                            <p class="p-4 text-center text-muted">
                                Your browser does not support embedded PDF viewing. 
                                <a href="<?php echo htmlspecialchars($phdEntrancePdf); ?>" target="_blank" class="btn btn-danger btn-sm ms-2">Click here to download and view the PDF.</a>
                            </p>
                        </iframe>
                    </div>
                </div>
