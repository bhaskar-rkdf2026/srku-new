...
<head>
  ...
  <title>bom1plzcpnl501949.prod.bom1.secureserver.net / localhost | phpMyAdmin 5.2.3</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en_GB&v=5.2.3"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.2.3"></script>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en_GB",server:"1",table:"",db:"",token:"357243732b436a4545462552605a767b",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:true,rootPath:true,arg_separator:"&",version:"5.2.3",auth_type:"cpanel",user:"cpses_ml4n5x390k"});
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i class="first"></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.aTkzNTY4MTQ=" data-pos="0"></span>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aTkzNTY4MTRfYmpnYjE=" data-vpath="cm9vdA==.aTkzNTY4MTQ=.YmpnYjE=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=i9356814_bjgb1"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=i9356814_bjgb1" title="Structure">i9356814_bjgb1</a>
  ...
  <li class="database database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aTkzNTY4MTRfaXBkbjE=" data-vpath="cm9vdA==.aTkzNTY4MTQ=.aXBkbjE=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=i9356814_ipdn1"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=i9356814_ipdn1" title="Structure">i9356814_ipdn1</a>
  ...
  <li class="database database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aTkzNTY4MTRfbmZqaDE=" data-vpath="cm9vdA==.aTkzNTY4MTQ=.bmZqaDE=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=i9356814_nfjh1"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=i9356814_nfjh1" title="Structure">i9356814_nfjh1</a>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aTkzNTY4MTRfc2p3djE=" data-vpath="cm9vdA==.aTkzNTY4MTQ=.c2p3djE=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=i9356814_sjwv1"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=i9356814_sjwv1" title="Structure">i9356814_sjwv1</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c3JrdW5pdmVyc2l0eTI0" data-vpath="cm9vdA==.c3JrdW5pdmVyc2l0eTI0" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=srkuniversity24"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=srkuniversity24" title="Structure">srkuniversity24</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="357243732b436a4545462552605a767b">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap disableAjax" href="index.php?route=/server/plugins">
              <img src="themes/dot.gif" title="Plug-ins" alt="Plug-ins" class="icon ic_b_plugin">&nbsp;Plug-ins
                          </a>
          </li>
              </ul>
    </div>
