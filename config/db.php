...
function autoInitializeTables($pdo) {
    ...
    if ($stmt->fetchColumn() <= 14) {
        ...
        $departments = [
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'fas fa-cogs', 'assets/images/dept_engg.jpg', 'Faculty of Engineering offers AICTE approved B.Tech, M.Tech and Polytechnic programs with cutting-edge computing, AI/ML, Robotics, IoT and Mechanical labs.', 'Dr. R. K. Sharma', '2015'],
            ['RKDF College Of Pharmacy', 'rkdf-college-of-pharmacy', 'fas fa-pills', 'assets/images/dept_pharma.jpg', 'PCI & AICTE approved pharmacy institute offering B.Pharm, M.Pharm, and Pharm.D with advanced pharmacology and formulation development labs.', 'Dr. S. K. Jain', '2015'],
            ...
            ['Sri Sai College Of Pharmacy', 'sri-sai-college-of-pharmacy', 'fas fa-capsules', 'assets/images/dept_pharma2.jpg', 'Premier institute specializing in pharmaceutical education, clinical research, drug design, and industrial training.', 'Dr. Neha Verma', '2016'],
            ['Dr. APJ. Abdul Kalam College Of Pharmacy', 'dr-apj-abdul-kalam-college-of-pharmacy', 'fas fa-flask', 'assets/images/dept_pharma3.jpg', 'Dedicated institute fostering advanced research in nanomedicine, pharmacognosy, and pharmaceutical biotechnology.', 'Dr. A. K. Patel', '2017'],
            ...
            ['R. N. Kapoor Memorial Institute Of Pharmaceutical Science', 'r-n-kapoor-memorial-institute-of-pharmaceutical-science', 'fas fa-tablets', 'assets/images/dept_pharma5.jpg', 'Excellence in pharmacy diploma, undergraduate, and postgraduate pharmaceutical chemistry studies.', 'Dr. Pooja Mishra', '2018'],
            ['RKDF Institute Science & Technology MCA', 'rkdf-institute-science-technology-mca', 'fas fa-laptop-code', 'assets/images/dept_ca.jpg', 'Delivering MCA, BCA, and PGDCA programs focused on Full-stack web development, Cloud Computing, Cyber Security, and AI.', 'Prof. Amit Saxena', '2015'],
            ...
            ['RKDF Institute Of Management', 'rkdf-institute-of-management', 'fas fa-chart-line', 'assets/images/dept_mgmt.jpg', 'Top-ranked business school offering MBA and BBA with dual specializations in Finance, Marketing, HR, Business Analytics, and Supply Chain.', 'Dr. V. K. Tiwari', '2015'],
            ['RKDF Institute Of Business Management', 'rkdf-institute-of-business-management', 'fas fa-briefcase', 'assets/images/dept_mgmt.jpg', 'Leading management academy offering specialized MBA, BBA, and management development programs.', 'Dr. V. K. Tiwari', '2016'],
            ...
            ['Sarvepalli Radhakrishnan College Of Law', 'sarvepalli-radhakrishnan-college-of-law', 'fas fa-balance-scale', 'assets/images/dept_law.jpg', 'Premier law college offering 3-year LL.B and 5-year integrated BA LL.B degrees.', 'Adv. Dr. S. K. Dubey', '2015'],
    ...
    if ($stmt->fetchColumn() <= 5) {
        ...
        $courses = [
            // Engineering
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'B.Tech in Computer Science & Engineering', 'b-tech-computer-science', 'UG', '4 Years', '10+2 with Physics, Mathematics & Chemistry (Min 50%)', '₹65,000 / Year', 'Comprehensive degree covering Data Structures, AI, Cloud Computing, Cyber Security, and Software Engineering.', 'Software Engineer, Data Analyst, Cloud Architect, Full Stack Developer'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'B.Tech in Artificial Intelligence & Data Science', 'b-tech-ai-ds', 'UG', '4 Years', '10+2 with PCM (Min 50%)', '₹70,000 / Year', 'Cutting-edge program focusing on Machine Learning, Deep Learning, Big Data Analytics, and NLP.', 'AI Engineer, Data Scientist, ML Ops Specialist'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'B.Tech in Mechanical Engineering', 'b-tech-mechanical', 'UG', '4 Years', '10+2 with PCM (Min 50%)', '₹55,000 / Year', 'Industry 4.0 aligned program with CAD/CAM, Robotics, Thermal Engineering, and Automobile Systems.', 'Design Engineer, Automobile Specialist, Production Manager'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'B.Tech in Civil Engineering', 'b-tech-civil', 'UG', '4 Years', '10+2 with PCM (Min 50%)', '₹55,000 / Year', 'Structural design, construction technology, geoinformatics, and smart city infrastructure.', 'Structural Engineer, Project Manager, Site Engineer'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'B.Tech in Electrical & Electronics Engineering', 'b-tech-eee', 'UG', '4 Years', '10+2 with PCM (Min 50%)', '₹55,000 / Year', 'Power systems, renewable energy, embedded systems, and IoT control engineering.', 'Electrical Consultant, Power Grid Engineer, IoT Specialist'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'M.Tech in Computer Science & Engineering', 'm-tech-cse', 'PG', '2 Years', 'B.E. / B.Tech in CSE / IT (Min 50%)', '₹60,000 / Year', 'Advanced research degree in High-Performance Computing, Distributed Systems, and AI Architectures.', 'Research Scientist, Principal Engineer, Academician'],
            ['RKDF Institute Of Science & Technology', 'rkdf-institute-of-science-technology', 'Diploma in Engineering (Polytechnic)', 'diploma-engineering', 'Diploma', '3 Years', '10th Standard pass from recognized board with Science & Math', '₹35,000 / Year', 'Hands-on practical engineering diploma in CSE, Mechanical, Civil, and Electrical streams.', 'Junior Engineer, Technical Officer, Plant Supervisor'],

            // Pharmacy
            ['RKDF College Of Pharmacy', 'rkdf-college-of-pharmacy', 'Bachelor of Pharmacy (B.Pharm)', 'b-pharm', 'UG', '4 Years', '10+2 with Physics, Chemistry & Biology/Maths (Min 50%)', '₹80,000 / Year', 'PCI approved degree covering Pharmacology, Pharmaceutics, Pharmacognosy, and Medicinal Chemistry.', 'Drug Inspector, Pharmacist, Clinical Research Associate, R&D Executive'],
            ['RKDF College Of Pharmacy', 'rkdf-college-of-pharmacy', 'Diploma in Pharmacy (D.Pharm)', 'd-pharm', 'Diploma', '2 Years', '10+2 with PCB / PCM (Min 45%)', '₹50,000 / Year', 'Foundational pharmacy course leading to Registered Pharmacist license with PCI.', 'Registered Retail/Hospital Pharmacist, Medical Representative'],
            ['RKDF College Of Pharmacy', 'rkdf-college-of-pharmacy', 'Master of Pharmacy (M.Pharm Pharmaceutics)', 'm-pharm-pharmaceutics', 'PG', '2 Years', 'B.Pharm from PCI recognized university (Min 55%)', '₹90,000 / Year', 'Advanced drug delivery systems, formulation research, and regulatory affairs.', 'Formulation Scientist, QA/QC Manager, Regulatory Affairs Specialist'],
            ['RKDF College Of Pharmacy', 'rkdf-college-of-pharmacy', 'Master of Pharmacy (M.Pharm Pharmacology)', 'm-pharm-pharmacology', 'PG', '2 Years', 'B.Pharm from PCI recognized university (Min 55%)', '₹90,000 / Year', 'In-depth molecular pharmacology, clinical toxicology, and pre-clinical drug evaluation.', 'Clinical Research Scientist, Toxicologist, Drug Safety Associate'],

            // Computer Applications
            ['RKDF Institute Science & Technology MCA', 'rkdf-institute-science-technology-mca', 'Master of Computer Applications (MCA)', 'mca', 'PG', '2 Years', 'BCA / B.Sc (CS/IT) / Any Bachelor Degree with Math at 10+2 or Graduation', '₹50,000 / Year', 'Industry-ready curriculum in Full-Stack Web Development, Cloud Computing, DevOps, and Enterprise App Design.', 'Senior Software Engineer, System Architect, Database Administrator'],
            ['RKDF Institute Science & Technology MCA', 'rkdf-institute-science-technology-mca', 'Bachelor of Computer Applications (BCA)', 'bca', 'UG', '3 Years', '10+2 in any stream with Mathematics / Computer', '₹40,000 / Year', 'Modern computing degree covering Python, Java, Web Technologies, Database Management, and Mobile Apps.', 'Software Developer, Web Designer, Technical Support Engineer'],
            ['RKDF Institute Science & Technology MCA', 'rkdf-institute-science-technology-mca', 'PGDCA (Post Graduate Diploma in Computer Applications)', 'pgdca', 'Diploma', '1 Year', 'Graduation in any discipline from recognized university', '₹25,000 / Year', 'Professional diploma providing IT skills, office automation, database concepts, and coding basics.', 'IT Assistant, Computer Operator, Data Entry Executive'],

            // Management & Business
            ['RKDF Institute Of Management', 'rkdf-institute-of-management', 'Master of Business Administration (MBA)', 'mba', 'PG', '2 Years', 'Graduation in any stream (Min 50%)', '₹60,000 / Year', 'Dual specialization in Marketing, Finance, Human Resource, Business Analytics, and International Business.', 'Business Manager, Marketing Executive, Financial Analyst, HR Manager'],
            ['RKDF Institute Of Management', 'rkdf-institute-of-management', 'Bachelor of Business Administration (BBA)', 'bba', 'UG', '3 Years', '10+2 in any stream (Min 45%)', '₹40,000 / Year', 'Core business administration curriculum with real-world case studies, entrepreneurship, and management internships.', 'Management Trainee, Sales Officer, Business Development Executive'],
