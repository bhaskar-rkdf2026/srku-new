...
<section class="about-hero-clean text-white py-5 position-relative" style="background: linear-gradient(135deg, #0b152d 0%, #16233f 45%, #630809 100%) !important; color: #ffffff !important;">
    <div class="container-xl position-relative z-2">
        ...
        <span class="about-hero-tag" style="display: inline-flex; align-items: center; gap: 6px; background: rgba(229, 169, 59, 0.16) !important; color: #ffcc00 !important; border: 1px solid rgba(229, 169, 59, 0.38) !important; font-size: 0.76rem; font-weight: 700; padding: 5px 14px; border-radius: 30px; letter-spacing: 0.6px; text-transform: uppercase; margin-bottom: 1rem;"><i class="fas fa-shield-alt me-1"></i> STATUTORY RECOGNITION</span>
        <h1 class="fw-bold display-6 mb-3 text-white" style="max-width:860px; line-height: 1.3;">Our Accreditations &amp; Regulatory Recognition &ndash; Guaranteeing Quality Excellence</h1>
        <p class="mb-4 text-white-50" style="max-width:780px; line-height:1.8; font-size: 1.02rem;">
            SRK University is proud to hold statutory recognition and apex approvals from UGC, NMC, AICTE, PCI, NCISM, NCH, NDC, INC, BCI, and MPPMC, validating benchmarked higher education standards.
        </p>
