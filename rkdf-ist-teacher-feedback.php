...
$pageTitle = "Teacher Feedback on Curriculum Form | RKDF IST | SRKU Bhopal";
$pageDesc = "Download official Teacher Feedback on Curriculum Form for RKDF Institute of Science & Technology (RKDF IST), Sarvepalli Radhakrishnan University Bhopal.";
$pageKeywords = "Teacher Feedback Curriculum RKDF IST, Faculty Feedback PDF, Engineering Curriculum Review Bhopal";
$activeNav = "departments";
require_once __DIR__ . '/includes/header.php';

$pdfUrl = BASE_URL . 'assets/pdf/rkdf-ist/feedback/teacher-curriculum-feedback.pdf';
?>
...
<div class="py-5 text-center text-white position-relative" style="background: linear-gradient(135deg, var(--srku-navy), var(--srku-maroon));">
    <div class="container-xl py-3">
        <span class="badge bg-warning text-dark fw-bold px-3 py-1 mb-2">Faculty &bull; Academic Review</span>
    ...
    <div class="container-xl py-2">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-white p-3 rounded-4 shadow-sm border mb-0 small">
                ...
                <li class="breadcrumb-item active text-danger fw-bold" aria-current="page">Teacher Feedback Form</li>
            </ol>
        </nav>
            ...
            <div class="row align-items-center g-4 position-relative z-2">
                <div class="col-12 col-lg-8">
                    <span class="badge bg-warning text-dark px-3 py-2 rounded-pill fw-bold mb-3">
                        <i class="fas fa-file-pdf me-1"></i> Prescribed Curriculum Review Format
                    </span>
                    <h2 class="h2 fw-bold text-white mb-3">Feedback on Curriculum by Teachers</h2>
                    <p class="text-white-50 mb-4" style="line-height: 1.7; font-size: 0.98rem;">
                        Official curriculum evaluation and enhancement document for faculty members of RKDF Institute of Science &amp; Technology. Faculty can preview the complete form below and download the official PDF copy.
                    </p>
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo $pdfUrl; ?>" download="Teacher-Feedback-Curriculum-RKDF-IST.pdf" class="btn btn-warning text-dark fw-bold px-4 py-3 rounded-pill shadow">
                    ...
                    <div class="p-4 rounded-4 bg-white text-navy shadow-sm">
                        ...
                        <ul class="list-unstyled d-flex flex-column gap-2 mb-0 small">
                            ...
                            <li class="d-flex justify-content-between">
                                <span class="text-muted">Target Stakeholders:</span>
                                <strong class="text-navy">Faculty &amp; Professors</strong>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card p-4 p-md-5 border-0 shadow-sm rounded-4 bg-white mb-4" id="pdf-viewer">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                        <div>
                            ...
                            <h3 class="h4 fw-bold text-navy mb-0">Teacher Feedback Form Preview</h3>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="<?php echo $pdfUrl; ?>" download="Teacher-Feedback-Curriculum-RKDF-IST.pdf" class="btn btn-sm btn-danger rounded-pill px-3 fw-bold">
                    ...
                    <div class="border rounded-4 overflow-hidden shadow-sm bg-light" style="min-height: 650px; height: 800px;">
                        <iframe src="<?php echo $pdfUrl; ?>#toolbar=1" class="w-100 h-100" style="border:none;" title="Teacher Feedback Form PDF">
            ...
            <div class="col-12 col-lg-4 col-xl-3">
                ...
                <div class="card p-4 border-0 shadow-sm rounded-4 mb-4 bg-white border">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="<?php echo BASE_URL; ?>rkdf-ist-student-feedback.php" class="p-2 px-3 rounded-3 text-decoration-none text-dark bg-light hover-danger small d-flex justify-content-between align-items-center">
                            <span class="fw-semibold">Student Feedback</span>
                ...
                <div class="card p-4 border-0 shadow-sm rounded-4 bg-light border">
                    ...
                    <p class="text-muted small mb-3">For any academic assistance or guidance regarding curriculum review submission:</p>
